...
class EAEL_Tooltip_Section
{
    ...
    public function register_controls($element)
    {
        ...
        $element->start_controls_section(
            ...
            [
                'label' => __('EA Advanced Tooltip', 'essential-addons-elementor'),
    ...
    public function after_render($element)
    {
        ...
        if ($settings['eael_tooltip_section_enable'] == 'yes') {
            add_filter('eael/section/after_render', [$this, 'eael_section_after_render']);
    ...
    public function eael_section_after_render($extensions) {
        $extensions[] = 'eael-tooltip-section';
