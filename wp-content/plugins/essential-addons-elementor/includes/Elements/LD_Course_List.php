...
class LD_Course_List extends Widget_Base
{
    ...
    {
        return esc_html__('EA LearnDash Course List', 'essential-addons-elementor');
    }
	...
	public function get_keywords() {
		return [ 'learn dash', 'learnDash', 'ea learndash' ];
	}
    ...
    protected function render()
    {
        ...
        if($courses) {
            ...
            echo "<h4>".__( 'No Courses Found!', 'essential-addons-elementor' ).'</h4>';
        }
        $html .= ob_get_clean();
