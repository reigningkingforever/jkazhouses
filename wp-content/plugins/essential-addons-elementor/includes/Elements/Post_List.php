    ...
    protected function render()
    {
        ...
        $this->add_render_attribute(
            ...
            [
                ...
                'data-post_type'      => $query_args['post_type'],
                'data-posts_per_page' => $query_args['posts_per_page'],
                'data-post__in'       => json_encode(!empty($query_args['post__in']) ? $query_args['post__in'] : []),
                'data-orderby'        => $query_args['orderby'],
                'data-order'          => $query_args['order'],
                'data-total_posts'    => $total_post,
                'data-offset'         => $query_args['offset'],
                ...
                'data-featured_posts' => $settings['featured_posts'],
                ...
                'data-next_icon'                  => (isset($settings['__fa4_migrated']['eael_post_list_pagination_next_icon_new']) || empty($settings['eael_post_list_pagination_next_icon'])) ? $settings['eael_post_list_pagination_next_icon_new']['value'] : $settings['eael_post_list_pagination_next_icon'],
                'data-prev_icon'                  => (isset($settings['__fa4_migrated']['eael_post_list_pagination_prev_icon_new']) || empty($settings['eael_post_list_pagination_prev_icon'])) ? $settings['eael_post_list_pagination_prev_icon_new']['value'] : $settings['eael_post_list_pagination_prev_icon'],
        ...
        ?>
				...
				<div class="post-list-ajax-search-form">
					<form action="" id="post-list-search-form-<?php echo $this->get_id(); ?>" autocomplete="off">
                        ...
                        <?php wp_nonce_field('eael_ajax_post_search_nonce_action', 'eael_ajax_post_search_nonce' ); ?>
		...
		<?php if ($settings['eael_post_list_pagination'] === 'yes'): ?>
			<div class="post-list-pagination">
				<button class="btn btn-prev-post" id="post-nav-prev-<?php echo $this->get_id(); ?>">
                    <?php if(isset($settings['__fa4_migrated']['eael_post_list_pagination_prev_icon_new']) || empty($settings['eael_post_list_pagination_prev_icon'])) { ?>
                        <?php Icons_Manager::render_icon($settings['eael_post_list_pagination_prev_icon_new']); ?>
                    <?php } else { ?>
				...
				<button class="btn btn-next-post" id="post-nav-next-<?php echo $this->get_id(); ?>" >
                    <?php if(isset($settings['__fa4_migrated']['eael_post_list_pagination_next_icon_new']) || empty($settings['eael_post_list_pagination_next_icon'])) { ?>
                        <?php Icons_Manager::render_icon($settings['eael_post_list_pagination_next_icon_new']); ?>
                    <?php } else { ?>
