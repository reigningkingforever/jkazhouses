...
class Toggle extends Widget_Base {
    ...
    protected function render() {
        ...
        $this->add_render_attribute( 'toggle-container', 'data-toggle-target', '#eael-toggle-container-' . esc_attr( $this->get_id() ) );
                    ...
                    <?php
                        if ( $settings['primary_content_type'] == 'content' ) {
                            ...
                            if ( !empty( $settings['primary_templates'] ) ) {
                                $eael_template_id = $settings['primary_templates'];
                    ...
                    <?php
                        if ( $settings['secondary_content_type'] == 'content' ) {
                            ...
                            if ( !empty( $settings['secondary_templates'] ) ) {
                                $eael_template_id = $settings['secondary_templates'];
                                $eael_frontend = new Frontend;
