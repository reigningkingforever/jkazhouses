...
class Interactive_Card extends Widget_Base {
   ...
   public function get_categories() {
	...
	protected function render( ) {
		...
		$icon = ((isset($settings['__fa4_migrated']['eael_interactive_card_close_button_icon_new']) || empty($settings['eael_interactive_card_close_button_icon'])) ? $settings['eael_interactive_card_close_button_icon_new']['value'] : $settings['eael_interactive_card_close_button_icon']);
	...
	<div id="interactive-card-<?php echo esc_attr( $this->get_id() ); ?>"  
		...
		<div class="content">
			<span class="close close-me"><i class="<?php echo $icon; ?>"></i></span>
