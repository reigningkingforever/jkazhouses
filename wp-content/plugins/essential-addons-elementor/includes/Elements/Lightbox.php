	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
            ...
            [
                ...
                'selectors'             => [
                    ...
                    '.eael-lightbox-modal-window-{{ID}}' => 'width: {{SIZE}}{{UNIT}}',
                ],
				'condition'             => [
		...
		$this->add_group_control(
			...
			[
				...
				'placeholder'           => '1px',
				'default'               => '1px',
				'selector'              => '.eael-lightbox-popup-window-{{ID}} .eael-lightbox-header .eael-lightbox-title',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '.eael-lightbox-popup-window.eael-lightbox-popup-window-{{ID}}',
			]
		);
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector'              => '.eael-lightbox-popup-window-{{ID}} .mfp-close',
				'condition'             => [
					'close_button'   => 'yes',
				],
            ]
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'                 => __( 'Background', 'essential-addons-elementor' ),
                'types'                 => [ 'classic', 'gradient' ],
                'selector'              => '.eael-lightbox-popup-window-{{ID}} .mfp-close:hover',
				'condition'             => [
					'close_button'   => 'yes',
				],
            ]
