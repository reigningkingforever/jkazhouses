...
namespace MyListing\Ext\Product_Vendors\Simple_Products;
...
class Simple_Products {
	...
	public function dashboard_pages() {
		...
		mylisting()->woocommerce()->add_dashboard_page( [
			...
			'template' => locate_template( 'includes/extensions/product-vendors/simple-products/views/my-products.php' ),
			'show_in_menu' => true,
			'order' => 5,
		] );
		...
		mylisting()->woocommerce()->add_dashboard_page( [
			...
			'template' => locate_template( 'includes/extensions/product-vendors/simple-products/views/add-product.php' ),
			'show_in_menu' => false,
		] );
	}
}